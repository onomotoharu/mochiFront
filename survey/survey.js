...
$(function(){
  ...
  App.getDetail(1670002663,function(recipe){
    console.log(recipe);
  });

  $('#item1 img').attr("src", "http://winvelab.net/cheese/img/"+survey[0]+".jpg");
  $('#item2 img').attr("src", "http://winvelab.net/cheese/img/"+survey[1]+".jpg");
  $('#item3 img').attr("src", "http://winvelab.net/cheese/img/"+survey[2]+".jpg");
  $('#item4 img').attr("src", "http://winvelab.net/cheese/img/"+survey[3]+".jpg");
  $('#item5 img').attr("src", "http://winvelab.net/cheese/img/"+survey[4]+".jpg");
  $('#item6 img').attr("src", "http://winvelab.net/cheese/img/"+survey[5]+".jpg");
  $('#item7 img').attr("src", "http://winvelab.net/cheese/img/"+survey[6]+".jpg");
  $('#item8 img').attr("src", "http://winvelab.net/cheese/img/"+survey[7]+".jpg");
  $('#item9 img').attr("src", "http://winvelab.net/cheese/img/"+survey[8]+".jpg");
  $('#item10 img').attr("src", "http://winvelab.net/cheese/img/"+survey[9]+".jpg");
  $('#item11 img').attr("src", "http://winvelab.net/cheese/img/"+survey[10]+".jpg");
  $('#item12 img').attr("src", "http://winvelab.net/cheese/img/"+survey[11]+".jpg");
  $('#item13 img').attr("src", "http://winvelab.net/cheese/img/"+survey[12]+".jpg");
  $('#item14 img').attr("src", "http://winvelab.net/cheese/img/"+survey[13]+".jpg");
  $('#item15 img').attr("src", "http://winvelab.net/cheese/img/"+survey[14]+".jpg");
  $('#item16 img').attr("src", "http://winvelab.net/cheese/img/"+survey[15]+".jpg");
  $('#item17 img').attr("src", "http://winvelab.net/cheese/img/"+survey[16]+".jpg");
  $('#item18 img').attr("src", "http://winvelab.net/cheese/img/"+survey[17]+".jpg");
  $('#item19 img').attr("src", "http://winvelab.net/cheese/img/"+survey[18]+".jpg");
  $('#item20 img').attr("src", "http://winvelab.net/cheese/img/"+survey[19]+".jpg");
  ...
  $(".box").click(function() {
    ...
    for(var i = 0;0<survey.length;i++) {
      if($("#item1").hasClass("box_on")){recipe_id = survey[i].id;}
    }
